...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-4 relative overflow-hidden">
      {/* Elementos decorativos de fondo usando los colores del tema */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradientes animados usando colores del tema */}
        <div 
          className="absolute top-0 -right-40 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse" 
      ...
      <div className="relative mx-auto w-full max-w-md pt-10 sm:pt-14">
        {/* Brand con animación de entrada */}
        ...
        <Card className="border border-border bg-card/50 backdrop-blur-xl text-card-foreground shadow-2xl p-8 rounded-xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 hover:shadow-primary/5 transition-shadow">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Input
                  ...
                  className="bg-background text-foreground border-border h-11 transition-all duration-300 focus:border-primary/50 focus:shadow-lg focus:shadow-primary/10"
                  required
                />
                {emailFocused && (
                  <div className="absolute inset-0 -z-10 bg-primary/5 rounded-lg blur-sm animate-in fade-in duration-200" />
                )}
              </div>
            </div>
            ...
            <Button 
              type="submit" 
              disabled={loading} 
              className="w-full h-11 rounded-lg font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] group relative overflow-hidden"
            >

// app/api/admin/schemas/[importType]/route.ts
...
export async function GET(req: Request, ctx: { params: Promise<{ importType: string }> }) {
  try {
    ...
    const upstream = await fetch(`${BASE}/admin/schemas/${importType}`, {
